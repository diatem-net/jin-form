...
/**
 * Validateur : teste si une date est supérieure à une date de référence
 */
class IsDateSuperior extends AbstractValidator
{
  ...
  public function isValid($value)
  {
    ...
    if (!$dValidator->isValid($value)) {
      $eMsg = Translation::get('validatorerror_isdatesuperior');
